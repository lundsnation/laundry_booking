...
import User, {UserUpdate} from '../../../classes/User'; // Assuming UserUpdate is correctly defined
                    ...
                    <ListItem>
                        <TextField
                            ...
                            onChange={(e) => setModification(prev => (
                                {...prev, app_metadata: {...prev.app_metadata, laundryBuilding: e.target.value as LaundryBuilding}}
                            ))
                            }
                        >
